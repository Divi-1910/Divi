  ...
  return (
    <div className="w-full font-sans md:px-10" ref={containerRef}>
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-6xl md:text-5xl mb-6 text-black dark:text-white max-w-4xl font-bold bg-gradient-to-r from-blue-500 via-purple-500 to-blue-500 bg-clip-text text-transparent animate-pulse">
        ...
        <p className="text-neutral-700 dark:text-neutral-300 text-2xl md:text-xl max-w-screen-md leading-relaxed font-light tracking-wide">
          I am actively looking for Opportunities to{" "}
          <span className="font-medium text-purple-500 dark:text-blue-400">
            Learn and Grow
          </span>{" "}
          and always eager to make
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-12 absolute left-3 md:left-3 w-12 rounded-full bg-gradient-to-br from-blue-600 to-purple-500 flex items-center justify-center shadow-lg shadow-blue-500/20">
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0 w-[3px] bg-gradient-to-t from-blue-500 via-purple-500 to-transparent from-[0%] via-[10%] rounded-full shadow-[0_0_8px_rgba(79,70,229,0.8)]"
          />
        </div>
      </div>
    </div>
