...
export default function Aurora(props: AuroraProps) {
  const {
    colorStops = ["#1E40AF", "#10B981", "#A855F7"], // Neon blue, emerald, purple
    amplitude = 0.8, // Reduced for smaller waves
    blend = 0.7 // Smoother transitions
  } = props;
  ...
  useEffect(() => {
    ...
    gl.clearColor(0, 0, 0, 0); // Transparent to show black background
    gl.enable(gl.BLEND);
